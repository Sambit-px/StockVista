                    ...
                    <div className="space-y-6">
                        ...
                        <motion.div initial={{ opacity: 0, y: 30 }}
                            ...
                            <motion.button whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }} className='inline-flex items-center justify-center gap-2 px-12 py-3 bg-gradient-to-r from-amber-200/60 to-slate-700 text-white rounded-full hover:shadow-2xl hover:shadow-amber-100/50 transition-all'>Start Investing
                                <motion.div
                                    animate={{ x: [0, 5, 0] }}
