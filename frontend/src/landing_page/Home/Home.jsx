...
function Home() {
    ...
    const quickActions = [
        { icon: Sparkles, label: "Market Watch", color: "text-blue-600" },
        { icon: Target, label: "Portfolio", color: "text-green-600" },
        { icon: Shield, label: "Fund Analysis", color: "text-purple-600" },
    ];
                ...
                >
                    {quickActions.map((action) => (
                        <motion.div
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="bg-white rounded-xl shadow-lg p-6 cursor-pointer border border-slate-700"
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {sections.map((section, index) => (
                        <motion.div
                            ...
                            className="rounded-3xl shadow-xl overflow-hidden cursor-pointer backdrop-blur-xl hover:shadow-2xl hover:shadow-amber-50 transition-shadow duration-700"
                        >
                            {/* Gradient Header */}
