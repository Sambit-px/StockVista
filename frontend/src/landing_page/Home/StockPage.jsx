...
export function StockPage() {
    ...
    const toggleWatchlist = async () => {
        ...
        setIsInWatchlist(newState); // ✅ instant UI
        ...
        try {
            await toast.promise(
                ...
                {
                    loading: newState ? "Adding..." : "Removing...",
                    success: newState ? "Added to watchlist" : "Removed from watchlist",
    ...
    const handleOrder = async () => {
        ...
        try {
            ...
            toast.success(
                `${orderSide} order placed for ${stockData.symbol}`
            );
        ...
        return (
            <div className="min-h-screen bg-[#0a0e17] flex items-center justify-center">
                <div className="text-center">
                    <div className="w-10 h-10 border-2 border-amber-100 border-t-transparent rounded-full animate-spin mx-auto mb-3" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="mt-2 mb-8 relative">
                            ...
                            <div className="flex justify-between items-center mt-4">
                                ...
                                >
                                    <Star
                                        className={`w-3.5 h-3.5 ${isInWatchlist ? "fill-amber-500 text-amber-500" : ""
                                            }`}
                                    />
                        ...
                        <div className="flex gap-6 border-b border-white/10 mb-6 overflow-x-auto hide-scrollbar">
                            {TABS.map((tab) => (
                                ...
                                >
                                    {tab.label}
                                    {activeTab === tab.id && (
                                        <div className="absolute bottom-0 left-0 w-full h-0.5 bg-amber-300 rounded-t-full" />
                                    )}
                                </button>
                            ))}
                        </div>
                    ...
                    <div className="lg:col-span-4">
                        <div className="sticky top-24 space-y-4">
                            ...
                            {/* Order Card */}
                            <div className="bg-[#111723] border-2 border-white/10 rounded-xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="space-y-4 text-sm">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <input
                                                ...
                                                className={`w-24 bg-[#1a2130] border-2 border-white/10 rounded py-1.5 px-3 text-right text-sm focus:outline-none placeholder:text-gray-600
                                                    ${priceType === "MARKET"
